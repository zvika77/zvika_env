...
RUN     ln -s /usr/local/bin/awless /awless
...
RUN echo "export SQL=/home/Vertica/Sql ;export LOG=/home/Vertica/Log ;export DMP=/home/Vertica/Dmp ;export SCRIPT=/home/Vertica/Script ;export TMP=/home/Vertica/Temp;export VHOME=/home/Vertica ;export TEMP=/home/Vertica/Temp ;export PATH=~/.local/bin:$HBASE_HOME/bin:$HADOOP_HOME/sbin:$HADOOP_HOME/bin:/opt/vertica/bin/:$PATH" >> /root/.bashrc && \
