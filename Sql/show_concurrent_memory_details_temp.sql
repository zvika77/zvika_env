...
left outer join
		...
		,transaction_id,statement_id,pool_name,(memory_inuse_kb/1024)::int memory_inuse_mb
 		from (
 		select
...
on b.slice_seconds between mem.queue_entry_timestamp and mem.acquisition_timestamp
