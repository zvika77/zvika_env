...
select node_name,time,total_memory_max_MB,free_memory_max_MB,buffer_memory_max_MB
,file_cache_memory_max_MB,free_memory_max_MB+buffer_memory_max_MB+file_cache_memory_max_MB as total_free_MB
 from (
