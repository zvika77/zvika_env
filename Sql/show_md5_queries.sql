select user_name,query_start,label,client_id,TIMESTAMPDIFF ('day', from_date, to_date) AS days,(query_duration_us/1000000)::int sec,processed_row_count,transaction_id,statement_id
