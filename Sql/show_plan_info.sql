SELECT path_id,
path_is_started p_start,path_is_completed p_complete,running_time,(memory_allocated_bytes/1024/1024)::int allocatedMB,substr(path_line,1,100) line,(read_from_disk_bytes/1024/1024)::int disk_readMB
...
select execution_step,sum(completion_time-time) as duration
