SELECT  
operation_start_timestamp as time,(timestampdiff('second',operation_start_timestamp,sysdate))::int b4_sec,node_name,operation_name,plan_type,table_schema,table_name,projection_name,((total_ros_used_bytes)/1024/1024)::int MB
