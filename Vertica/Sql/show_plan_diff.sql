...
case when plan_diff = '===>' then first_path_line else substr(first_path_line,1,50) end as :1,
case when plan_diff = '===>' then second_path_line else substr(second_path_line,1,50) end as :3
from (
